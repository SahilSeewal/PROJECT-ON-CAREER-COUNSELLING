 ...
 * @author Sahil Seewal
 */
public class industrial10 extends javax.swing.JFrame {

    /**
     * Creates new form industrial10
     */
    public industrial10() {
        initComponents();
    }
    ...
    private void formWindowGainedFocus(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowGainedFocus
        ...
        try
{
setTitle(" "+"INDUSTRIAL COURSES FOR 10TH PASS");    
    //int j;
...
//String  selected=jList1.getSelectedValue();        
        try {
            ...
            Logger.getLogger(industrial10.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(industrial10.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new industrial10().setVisible(true);
            }
        });
    }
