 ...
 * @author Sahil Seewal
 */
public class non_medical12 extends javax.swing.JFrame {

    /**
     * Creates new form non_medical12
     */
    public non_medical12() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("SELECT YOUR DESIRED COURSE");
...
System.out.print(" "+e);
    ...
    private void formWindowGainedFocus(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowGainedFocus
        // TODO add your handling code here:
               try
{ setTitle(" " +"NON-MEDICAL COURSES FOR 12TH PASS ");
    int pos=jComboBox1.getSelectedIndex();
    //int j;
    Class.forName("java.sql.Driver");
String database="jdbc:mysql://localhost:3306/course8";
...
Desktop d=Desktop.getDesktop();
        ...
        try {
            ...
            Logger.getLogger(non_medical12.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(non_medical12.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new non_medical12().setVisible(true);
            }
        });
    }
