 ...
 * @author Sahil Seewal
 */
public class industrial8 extends javax.swing.JFrame {

    /**
     * Creates new form industrial8
     */
    public industrial8() {
        initComponents();
    }
...
try
{ setTitle(" " +"INDUSTRIAL COURSES FOR 8TH PASS ");
...
Desktop d=Desktop.getDesktop();
        try {
            ...
            Logger.getLogger(industrial8.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(industrial8.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new industrial8().setVisible(true);
            }
        });
    }
