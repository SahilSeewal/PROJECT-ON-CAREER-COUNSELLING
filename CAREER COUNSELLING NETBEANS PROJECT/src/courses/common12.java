 ...
 * @author Sahil Seewal
 */
public class common12 extends javax.swing.JFrame {

    /**
     * Creates new form common12
     */
    public common12() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("SELECT DESIRD COURSE");
...
System.out.print(" "+e);
    ...
    private void formWindowGainedFocus(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowGainedFocus
        ...
        try
{
setTitle(" "+"COMMON COURSES FOR 12TH PASS");    
    //int j;
    Class.forName("java.sql.Driver");
String database="jdbc:mysql://localhost:3306/course8";
Connection conn=((Connection)DriverManager.getConnection(database,"root","root"));
...
Desktop d=Desktop.getDesktop();
        ...
        try {
            ...
            Logger.getLogger(common12.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(common12.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
